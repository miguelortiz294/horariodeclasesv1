...
public class EditarActivity extends AppCompatActivity {
    ...
    private void cargarDatos() {
        ...
        if (c.moveToFirst()) {
            ...
            txtProfesor.setText(c.getString(c.getColumnIndexOrThrow("PROFESOR")));
            txtSala.setText(c.getString(c.getColumnIndexOrThrow("SALA")));
            txtHoraInicio.setText(c.getString(c.getColumnIndexOrThrow("HORA_INICIO")));
            txtHoraFin.setText(c.getString(c.getColumnIndexOrThrow("HORA_FIN")));

            String diaDB = c.getString(c.getColumnIndexOrThrow("DIA"));
    ...
    private void actualizarRamo() {
        ...
        boolean ok = db.editar(codigo, nombre, profesor, sala, dia, horaInicio, horaFin);
